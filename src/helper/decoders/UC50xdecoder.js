...
function milesightDeviceDecodeUC50x(pdu) {
    ...
    for (i = 0; i < bytes.length;) {
        ...
        // ANALOG INPUT TYPE
            ...
            decoded[chn_name] = {
                value:  readAnalogInputType(channel & 0x0f),
                unit: ""
            };  
            i += 1;
        }
        ...
        // firmware version 1.10 and below and UC50x V1, change 1000 to 100.
            ...
            decoded[adc_channel_name] =  {
                value: readInt16LE(bytes.slice(i, i + 2)) / 1000,
                unit: ""
            };  
            decoded[adc_channel_name + "_min"] =  {
                value:  readInt16LE(bytes.slice(i + 2, i + 4)) / 1000,
                unit: ""
            };  
            decoded[adc_channel_name + "_max"] =  {
                value:  readInt16LE(bytes.slice(i + 4, i + 6)) / 1000,
                unit: ""
            };  
            decoded[adc_channel_name + "_avg"] =  {
                value:  readInt16LE(bytes.slice(i + 6, i + 8)) / 1000,
                unit: ""
            };  
            i += 8;
        }
        ...
        // SDI-12
            ...
            decoded[name] =  {
                value:  readString(bytes.slice(i, i + 36)),
                unit: ""
            };  
            i += 36;
        }
        ...
        // ADC alert (UC50x v3)
            ...
            decoded[adc_channel_name + "_alarm"] = {
                value:   readAlarm(bytes[i++]),
                unit: ""
            }; 
        }
        ...
        //         value:  readOnOffStatus(bytes[i]),
        //         unit: ""
        //     };  readUInt32LE(bytes.slice(i + 5, i + 9));
        //     data.gpio_2 =  {
        //         value:  readOnOffStatus(bytes[i]),
        //         unit: ""
        //     }; readUInt32LE(bytes.slice(i + 10, i + 14));
        //     data.adc_1 = {
        //         value:  readOnOffStatus(bytes[i]),
        //         unit: ""
        //     };  readInt32LE(bytes.slice(i + 14, i + 18)) / 1000;
        //     data.adc_2 = {
        //         value:  readOnOffStatus(bytes[i]),
        //         unit: ""
        //     };  readInt32LE(bytes.slice(i + 18, i + 22)) / 1000;
        //     i += 22;
...
module.exports = {milesightDeviceDecodeUC50x};
