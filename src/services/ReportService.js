...
// const createReport = async (reportData, customerId) => {
//   try {
...
// const getReports = async (customerId) => {
//   try {
//     // Query the database to fetch all reports
//     console.log("testing------> getReport customerId", customerId);
...
const getReports = async (customerId) => {
  try {
    // Query the database to fetch all reports
    console.log("testing------> getReport cutomerId", customerId);
    const reports = await prisma.addreport.findMany({
      where: {
        customerId: customerId
      }
