...
CREATE TABLE `scheduledownlink` (
    ...
    `activeStartTime` INTEGER NOT NULL,
    `activeEndTime` INTEGER NOT NULL,
    `activeDays` JSON NOT NULL,
    `reseduledDay` JSON NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `card` (
    ...
    `displayFormula` JSON NULL,
    `displayUnit` JSON NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `displayFormulaSecondary` JSON NULL,
    `displayUnitSecondary` JSON NULL,
...
-- CreateTable
CREATE TABLE `device_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(191) NOT NULL,
    `manufacture` VARCHAR(191) NOT NULL,
    `mainOutput` JSON NOT NULL,
    ...
    `deviceId` VARCHAR(191) NOT NULL,
    `location` VARCHAR(191) NOT NULL,
    `hardwareType` VARCHAR(191) NOT NULL,
    `network` VARCHAR(191) NOT NULL,
    `deviceLocationName` VARCHAR(191) NOT NULL,
...
-- CreateTable
CREATE TABLE `alerts_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(191) NULL,
    `deviceId` INTEGER NOT NULL,
    `operator` VARCHAR(191) NOT NULL,
...
-- CreateTable
CREATE TABLE `deviceattribute_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(191) NOT NULL,
    `value` VARCHAR(191) NOT NULL,
    `deviceId` INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE `devicedecodedata_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `devEui` VARCHAR(191) NOT NULL,
    `attributesName` VARCHAR(191) NOT NULL,
    `attributesValue` VARCHAR(191) NOT NULL,
...
-- CreateTable
CREATE TABLE `deviceserverdata_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `devEui` VARCHAR(191) NOT NULL,
    `seqno` INTEGER NOT NULL,
    `port` INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE `downlinkdevice_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `devEui` VARCHAR(191) NOT NULL,
    `downlinkController` VARCHAR(191) NOT NULL,
    `classType` VARCHAR(191) NOT NULL,
...
-- CreateTable
CREATE TABLE `notification_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `message` VARCHAR(191) NOT NULL,
    `deviceId` INTEGER NOT NULL,
    `alertId` INTEGER NULL,
...
-- CreateTable
CREATE TABLE `output_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `deviceId` INTEGER NOT NULL,
    `name` VARCHAR(191) NOT NULL,
    `unit` VARCHAR(191) NOT NULL,
...
-- CreateTable
CREATE TABLE `autodownlinkwithdelay_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `downlinkController` VARCHAR(191) NOT NULL,
    `isActive` BOOLEAN NOT NULL,
    `timeoutMinutes` INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE `addreport_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `reportName` VARCHAR(191) NOT NULL,
    `description` VARCHAR(191) NOT NULL,
    `duration` VARCHAR(191) NOT NULL,
...
-- CreateTable
CREATE TABLE `addwidget_delete_bkp` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `pageName` VARCHAR(191) NOT NULL,
    `stepOneData` JSON NOT NULL,
    `stepTwoData` JSON NOT NULL,
...
-- AddForeignKey
ALTER TABLE `permissions` ADD CONSTRAINT `permissions_role_id_fkey` FOREIGN KEY (`role_id`) REFERENCES `Role`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `permissions` ADD CONSTRAINT `permissions_admin_id_fkey` FOREIGN KEY (`admin_id`) REFERENCES `customer`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
